...
public class GlobalParams {
    ...
    private static ThreadLocal<String>  pcloudy = new ThreadLocal<String>();

    public  String getPcloudy() {
        return pcloudy.get();
    }

    public  void setPcloudy(String pcloudy1) {
        pcloudy.set(pcloudy1);
    }
    ...
    public  void setEmulator(String emulator1) {
        emulator.set(emulator1);
    }
